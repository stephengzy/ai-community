        ...
        replies: [
          {
            id: "bc2r1",
            author: users[6],
            content: "谢谢初一！hover的tooltip花了不少时间调，能被注意到很开心。",
            isSponsor: false,
            likes: 3,
...
export const notifications: Notification[] = [
  // ── Unread ──────────────────────────────────────────────
  {
    ...
    actor: users[2],
    targetType: "post",
    contentPreview: "@初一(高震宇) 你之前提到的那个自动化方案能展开聊聊吗？感觉对我们部门也很有启发",
    isRead: false,
  ...
  },
  {
    ...
    actor: users[3],
    targetType: "comment",
    contentPreview: "@初一(高震宇) 上次demo的那个工具叫什么来着？我想给我们组也用起来",
    isRead: true,
  ...
  },
  {
    ...
    actor: users[8],
    targetType: "post",
    contentPreview: "推荐 @初一(高震宇) 做的代码审查助手，已经帮我们团队省了大量时间",
    isRead: true,
    createdAt: "2026-04-03T11:00:00Z",
  },
  {
